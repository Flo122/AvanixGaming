...
*/
avanix_adminlevel = nil;
avanix_coplevel = nil;
avanix_donator = nil;

"BIS_fnc_MP_packet" addPublicVariableEventHandler {_this call avanix_fnc_MPexec};
"avanix_fnc_MP_packet" addPublicVariableEventHandler {_this call avanix_fnc_MPexec};
...
[] execVM "core\fn_init.sqf";
[] execVM "core\avanix\misc\fn_emptyFuel.sqf";
