...
{
	[_caller,_target,_posCaller,_dir] spawn avanix_fnc_pushFunction;
}
	else
{
	[[_caller,_target,_posCaller,_dir],"avanix_fnc_pushFunction",_target,false] spawn avanix_fnc_MP;
};