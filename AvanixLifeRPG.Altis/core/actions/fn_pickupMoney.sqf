/*
	...
	Picks up money
*/
if((time - avanix_action_delay) < 1.5) exitWith {
...
if(!isNil {_val}) then
{
	...
	titleText[format[localize "STR_NOTF_PickedMoney",[_val] call avanix_fnc_numberText],"PLAIN"];
	_toLog = format ["2|%1 (%3) hat %2 aufgehoben.", name player, [_val] call avanix_fnc_numberText,getPlayerUID player];
