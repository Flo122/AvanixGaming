...
_door = [_house] call avanix_fnc_nearestDoor;
...
[[2,"STR_House_Raid_NOTF",true,[(_house getVariable "house_owner") select 1]],"avanix_fnc_broadcast",true,false] spawn avanix_fnc_MP;
