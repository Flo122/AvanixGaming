...
if(!createDialog "avanix_Vehicle_Shop_v2") exitWith {};

avanix_veh_shop = [_shop,_spawnpoints,_shopFlag,_disableBuy]; //Store it so so other parts of the system can access it.
...
_vehicleList = [_shop] call avanix_fnc_vehicleListCfg;
