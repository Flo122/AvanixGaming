...
{
	{
		_inv = _inv + format["%1 %2<br/>",_x select 1,[([_x select 0,0] call avanix_fnc_varHandle)] call avanix_fnc_varToStr];
	...
	{
		[[getPlayerUID _civ,_civ getVariable["realname",name _civ],"482"],"avanix_fnc_wantedAdd",false,false] spawn avanix_fnc_MP;
	};
	
	[[getPlayerUID _civ,_civ getVariable["realname",name _civ],"481"],"avanix_fnc_wantedAdd",false,false] spawn avanix_fnc_MP;
	[[0,"STR_Cop_Contraband",true,[(_civ getVariable["realname",name _civ]),[_illegal] call avanix_fnc_numberText]],"avanix_fnc_broadcast",west,false] spawn avanix_fnc_MP;
}
	else
{
...
if(_robber) then
{
	[[0,"STR_Cop_Robber",true,[(_civ getVariable["realname",name _civ])]],"avanix_fnc_broadcast",true,false] spawn avanix_fnc_MP;
};