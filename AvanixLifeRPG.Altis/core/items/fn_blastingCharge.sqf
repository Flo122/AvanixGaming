...
if(!([false,"blastingcharge",1] call avanix_fnc_handleInv)) exitWith {}; //Error?

_vault setVariable["chargeplaced",true,true];
[[0,"STR_ISTR_Blast_Placed"],"avanix_fnc_broadcast",west,false] spawn avanix_fnc_MP;
hint localize "STR_ISTR_Blast_KeepOff";
_handle = [] spawn avanix_fnc_demoChargeTimer;
[[],"avanix_fnc_demoChargeTimer",west,false] spawn avanix_fnc_MP;
