...
if(!([false,_item,(parseNumber _val)] call avanix_fnc_handleInv)) exitWith {hint "Couldn't give that much of that item, maybe you don't have that amount?";ctrlShow[2002,true];};
[[_unit,_val,_item,player],"avanix_fnc_receiveItem",_unit,false] spawn avanix_fnc_MP;
