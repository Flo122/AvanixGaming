...
if(_action) then {
	[player] join _group;
	[[4,_group],"TON_fnc_updateGang",false,false] spawn avanix_fnc_MP;
	[[5,_group],"TON_fnc_updateGang",false,false] spawn avanix_fnc_MP;
} else {
	_grpMembers = grpPlayer getVariable "gang_members";
	_grpMembers = _grpMembers - [steamid];
	grpPlayer setVariable["gang_members",_grpMembers,true];
	[[4,_grpMembers],"TON_fnc_updateGang",false,false] spawn avanix_fnc_MP;
	[[5,_grpMembers],"TON_fnc_updateGang",false,false] spawn avanix_fnc_MP;
};