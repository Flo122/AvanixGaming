...
if(isNull (findDisplay 2620)) then {
	if(!(createDialog "avanix_My_Gang_Diag")) exitWith {}; //NOOOOOOOOOOOOOOOOOOOOOOOoooooooooooooOOOOOOOOOOOOOOOOOOOOOOOOOOO00000000000000oooooo
};
...
(getControl(2620,601)) ctrlSetText format[(localize "STR_GNOTF_Funds")+ " %1€",[_gangBank] call avanix_fnc_numberText];
