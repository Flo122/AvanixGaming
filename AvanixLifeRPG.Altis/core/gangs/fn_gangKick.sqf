...
[[_unit,grpPlayer],"TON_fnc_clientGangKick",_unit,false] spawn avanix_fnc_MP; //Boot that bitch!
[[4,grpPlayer],"TON_fnc_updateGang",false,false] spawn avanix_fnc_MP; //Update the database.
[[5,grpPlayer],"TON_fnc_updateGang",false,false] spawn avanix_fnc_MP; //Update the database.
[] call avanix_fnc_gangMenu;