...

{
    ...
    _x addaction ["Auftanken","call avanix_fnc_vehicleCheck"];
    _x addaction ["BenzinPreis","call avanix_fnc_fuelPrices"];
...

{
    ...
    _x addaction ["Auftanken","call call avanix_fnc_vehicleCheck"];
    _x addaction ["BenzinPreis","call call avanix_fnc_fuelPrices"];
