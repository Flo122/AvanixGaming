...
{	
	...
	case (_vehicle iskindof "O_Truck_02_fuel_F"): {_liter = 0.00900; _completeliter = 400;};
	case (_vehicle iskindof "I_Truck_02_covered_F"): {_liter = 0.00900; _completeliter = 400;};
	case (_vehicle iskindof "O_Truck_02_box_F"): {_liter = 0.00900; _completeliter = 400;};
	//Tempest
	...
	//Gepanzerte
	case (_vehicle iskindof "O_MRAP_02_F"): {_liter = 0.00900; _completeliter = 350;};
	case (_vehicle iskindof "B_MRAP_01_F"): {_liter = 0.00900; _completeliter = 350;};
	case (_vehicle iskindof "I_MRAP_03_F"): {_liter = 0.00900; _completeliter = 350;};
...
_action = [
	format["Moechtest du dein Fahrzeug %1 voll betanken? Das Tanken kostet %2 € und wird von deinem Konto abgezogen. Sollte der Tankvorgang unterbrochen werden, wird kein Geld erstattet.",_vehicleName,[_cost] call avanix_fnc_numberText],
	"Betanken",
	"Ja",
	"Nein"
