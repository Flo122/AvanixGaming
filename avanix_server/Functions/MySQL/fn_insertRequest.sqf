...
//Error checks
if((_uid == "") OR (_name == "")) exitWith {systemChat "Falsche UID oder Name";}; //Let the client be 'lost' in 'transaction'
...
if(typeName _queryResult == "STRING") exitWith {[[],"SOCK_fnc_dataQuery",(_player _returnToSender),false] spawn avanix_fnc_MP;}; //There was an entry!
if(count _queryResult != 0) exitWith {[[],"SOCK_fnc_dataQuery",(_player _returnToSender),false] spawn avanix_fnc_MP;};
...
[[],"SOCK_fnc_dataQuery",(_player _returnToSender),false] spawn avanix_fnc_MP;