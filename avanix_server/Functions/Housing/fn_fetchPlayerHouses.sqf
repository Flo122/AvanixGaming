...
_return = [];
{
	...
	_inventory = [_x select 4] call DB_fnc_mresToArray;
	...
	/*RENTTIME*/ _house setVariable["renttime",_x select 5,true];
	/*RENTED*/ _house setVariable["rented",_x select 6,true];
	/*BOUGHT*/ _house setVariable["bought",_x select 7,true];
	{
