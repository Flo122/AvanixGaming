...
#define CASH avanix_displayedCash
#define BANK avanix_displayedBank
...
#define EXTDB_FAILED(MESSAGE) \
	...
	PVAR_ALL("avanix_server_extDB_notLoaded"); \
	diag_log MESSAGE;
...
#define ITEM_VARNAME(varName) format["avanix_inv_%1",M_CONFIG(getText,"VirtualItems",varName,"variable")]
...
#define avanix_SETTINGS(TYPE,SETTING) TYPE(missionConfigFile >> "avanix_Settings" >> SETTING)
